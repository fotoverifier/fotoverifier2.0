...
def denoising(image_bytes):
    ...
    nlm_url = upload_to_cloudinary(nlm_png.tobytes(), filename="denoised_nlm")
    bilateral_url = upload_to_cloudinary(bilateral_png.tobytes(), filename="denoised_bilateral")
