    ...
    children: [
      {
        id: 'metadata',
        label: 'Metadata',
        file: '/manual/metadata_analysis/metadata.md',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        file: '/manual/tampering/ela.md',
      },
      {
        id: 'JPEGG',
        label: 'JPEG Ghost',
        file: '/manual/tampering/jpeg_ghost.md',
      },
    ],
  },
  {
    ...
    children: [
      { id: 'CFA', label: 'CFA', file: '/manual/computational/cfa.md' },
      {
        id: 'Denoise',
        label: 'Denoise',
        file: '/manual/computational/Denoise.md',
      },
      {
        id: 'Edge Detection',
        label: 'Edge Detection',
        file: '/manual/computational/EdgeDetection.md',
      },
    ],
  },
  {
    ...
    children: [
      {
        id: 'Bird Eye',
        label: 'Bird Eye',
        file: '/manual/img_transform/bird_eye.md',
      },
      {
        id: 'Panorama',
        label: 'Panorama',
        file: '/manual/img_transform/panorama.md',
      },
      {
        id: 'Rectify',
        label: 'Rectify',
        file: '/manual/img_transform/rectify.md',
      },
    ],
  },
];
      ...
      <aside className="w-fit max-w-[20rem] h-full sticky top-0 overflow-y-auto border-r p-4 bg-white shrink-0">
        ...
        <div className="mt-6 p-4 bg-yellow-50 border border-yellow-300 rounded-xl text-sm text-yellow-800 shadow-sm">
          ...
          <p className="mt-1 ml-7">
            Translation for this page will be implemented in the future.
          </p>
        </div>
      </aside>
