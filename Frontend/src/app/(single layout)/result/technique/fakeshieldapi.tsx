    ...
    <>
      {!isSubmitted ? (
        ...
        <div className="mt-6 grid grid-cols-4 gap-4 auto-rows-max">
          <div className="col-span-3 bg-white border border-blue-200 rounded-lg shadow-sm flex flex-col max-h-[400px]">
            ...
            <div className="p-4 overflow-y-auto flex-1">
              <div className="grid grid-cols-2 gap-4 items-stretch">
                {/* Left Column: Summary, Lighting, Edge */}
                <div className="space-y-2">
                  <Section title="Summary" color="blue">
                    The original photograph appears to be a natural, unaltered
                    image of a bird in mid-flight against a backdrop of a
                    landscape. The ELA image shows signs of potential
                    manipulation, particularly around the bird.
                  </Section>
                  <Section title="Lighting inconsistencies" color="blue">
                    There are noticeable discrepancies in lighting on the bird
                    compared to the background, suggesting it may have been
                    inserted or altered.
                  </Section>
                  <Section title="Edge artifacts" color="blue">
                    The edges of the bird appear sharper than those in the
                    background, indicating different compression levels.
                  </Section>
                </div>

                {/* Right Column: Semantic, Political, Confidence */}
                <div className="space-y-2 self-stretch flex flex-col justify-between">
                  <Section title="Semantic anomalies" color="blue">
                    Nothing suggests a direct political meaning; however, it
                    could symbolize nature or environmental themes.
                  </Section>
                  <Section title="Political Relevancy" color="blue">
                    Low
                  </Section>
          ...
          {/* Shared Judgment (Right side, spans 2 rows) */}
          <div className="row-span-2 bg-white border border-green-200 rounded-lg shadow-sm flex flex-col max-h-[820px]">
            ...
            <div className="p-4 overflow-y-auto flex-1 space-y-2">
              <Section title="Consensus Summary" color="green">
                Both agree that the bird may have been manipulated, despite the
                photo’s natural appearance.
              </Section>
          ...
          {/* Investigator B (Row 2, 3/4 width) */}
              ...
              <div className="grid grid-cols-2 gap-4 items-stretch">
                ...
                <div className="space-y-2">
                  <Section title="Summary" color="purple">
                    The original image seems plausible, but the ELA reveals
                    unusual compression near the bird. These regions raise
                    suspicion about potential editing in the image composition.
                  </Section>
                  <Section title="Lighting inconsistencies" color="purple">
                    Lighting on the bird doesn’t match the surrounding
                    environment.
                  </Section>
                  <Section title="Edge artifacts" color="purple">
                    Irregular transitions between bird and background suggest
                    tampering.
                  </Section>
                </div>
                ...
                <div className="space-y-2 self-stretch flex flex-col justify-between">
                  ...
                  <Section title="Political Relevancy" color="purple">
                    Low
                  </Section>
...
const Section = ({
  ...
  <div className="mb-2">
    ...
    <div className={`bg-${color}-50 p-2 rounded text-sm text-gray-800`}>
      {children}
    </div>
  </div>
);
