...
import styles from "./info_button.module.css"
interface ComponentProps {
  // Define props here if needed, e.g.:
  title?: string;
}

const InfoButton: React.FC<ComponentProps> = ({ title = "Default Title" }) => {
  return (
    <div>
   <div className={styles.info_button}>
          <svg viewBox="0 0 448 512" className={styles.info_svgIcon}><path d="M290.671,135.434c37.324-3.263,64.949-36.175,61.663-73.498c-3.241-37.324-36.152-64.938-73.476-61.675
